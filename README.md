...
4. 設定:
   - **Token name**: `hama-atsume`（任意）
   - **Expiration**: 1年など任意
   - **Repository access**: *Only select repositories* → `magosuke-net/hama-atsume` を選択
...
公開URL（予定）:
`https://magosuke-net.github.io/hama-atsume/`
...
- データ: `data/hamas.json`（コミット履歴がそのまま更新ログ）
- 写真: `data/photos/<uuid>.jpg`
